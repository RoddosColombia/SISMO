...
- [x] **CHAT-03**: Agente propone asiento con cuentas reales de plan_cuentas_roddos, espera confirmacion explicita del usuario — maximo una pregunta por turno de interaccion
